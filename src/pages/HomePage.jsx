      ...
      <section className="bg-gradient-to-br from-blue-800 to-blue-600 text-white py-16 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <button
            ...
            className="bg-yellow-400 text-gray-900 px-8 py-3 rounded-lg font-semibold text-lg hover:bg-yellow-300 transition-colors shadow-md"
          >
            Make Me Happy
          </button>
        </div>
      ...
      <section className="py-12 px-4 bg-blue-50 border-t border-blue-100">
        <div className="max-w-xl mx-auto text-center">
          ...
          <div className="flex gap-3 justify-center flex-wrap">
            <button
              onClick={() => onNavigate('submit')}
              className="bg-yellow-400 text-gray-900 px-6 py-2.5 rounded-lg font-medium hover:bg-yellow-300 transition-colors"
            >
              New Request
            </button>
            <button
